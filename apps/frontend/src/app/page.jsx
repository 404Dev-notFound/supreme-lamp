    ...
    <div className="min-h-screen text-zinc-100 font-sans selection:bg-primary/30">
      ...
      >
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-4 tracking-tight text-white shadow-sm">
              Everything you need to grow.
            </h2>
            <p className="text-zinc-300 text-lg max-w-2xl">
              Stop guessing what to learn next. flowCTRL analyzes your skills
              and provides a systematic path to your dream career.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="p-6 rounded-2xl glass-card hover:bg-card/70 transition-colors group">
              ...
              <p className="text-zinc-400 leading-relaxed text-sm">
                Discover exactly what you know and what you&apos;re missing
                compared to top industry requirements.
              </p>
            </div>
            ...
            <div className="p-6 rounded-2xl glass-card hover:bg-card/70 transition-colors group">
              ...
              <p className="text-zinc-400 leading-relaxed text-sm">
                Connect directly with industry leaders, engineers, and product
                managers who have been there.
              </p>
            </div>
            ...
            <div className="p-6 rounded-2xl glass-card hover:bg-card/70 transition-colors group">
              ...
              <p className="text-zinc-400 leading-relaxed text-sm">
                Showcase your projects in an interactive, auto-generated
                portfolio that recruiters love.
              </p>
            </div>
            ...
            <div className="p-6 rounded-2xl glass-card hover:bg-card/70 transition-colors group">
              ...
              <p className="text-zinc-400 leading-relaxed text-sm">
                Get matched with companies looking for your exact skill profile
                and readiness score.
              </p>
              <button
      ...
      <section className="py-32 px-6 relative overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto text-center relative z-10 glass-card p-12 rounded-3xl">
          ...
          <div className="mt-8 flex items-center justify-center gap-6 text-sm text-zinc-500">
            ...
            <span className="flex items-center gap-2">
              <CheckCircle2 className="w-4 h-4" /> 14-day premium trial
            </span>
          </div>
        </div>
      </section>
