            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <div className="md:col-span-2 flex flex-col gap-6">
                ...
                <div className="glass-card p-6 rounded-2xl border border-white/10 flex-1">
                  ...
                  <ul className="space-y-3">
                    {result.top_3_priority_fixes?.map(
                      (fix: string, i: number) => (
                        <li
                          key={i}
                          className="flex items-start gap-3 text-sm text-zinc-300"
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="glass-card p-6 rounded-2xl border border-white/10">
                ...
                <ul className="space-y-4">
                  {result.strengths?.map((str: StrengthItem, i: number) => (
                    <li
                      key={i}
              ...
              <div className="glass-card p-6 rounded-2xl border border-white/10">
                ...
                <ul className="space-y-4">
                  {result.flaws?.map((flaw: FlawItem, i: number) => (
                    <li
                      key={i}
                      className="bg-white/5 p-4 rounded-xl border border-white/5"
                    >
              ...
              <div className="glass-card p-6 rounded-2xl border border-white/10">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  {Object.entries(result.section_feedback).map(
                    ([section, feedback]: [string, string], i: number) => (
