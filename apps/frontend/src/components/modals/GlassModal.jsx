      ...
      <Dialog as="div" className="relative z-50" onClose={onClose}>
        ...
        <div className="fixed inset-0 overflow-y-auto">
          <div className="flex min-h-full items-center justify-center p-4 text-center">
            ...
            >
              <Dialog.Panel className="w-full max-w-lg transform overflow-hidden rounded-3xl bg-zinc-950/90 backdrop-blur-2xl border border-white/15 shadow-2xl shadow-black/80 transition-all text-left">
