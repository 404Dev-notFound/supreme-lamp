...
import type { RoadmapTrackSummary } from "@flowctrl/types";

interface DevRoadmapCardProps {
  roadmap: RoadmapTrackSummary;
}
...
export default function DevRoadmapCard({ roadmap }: DevRoadmapCardProps) {
  const IconComponent =
  ...
  const categoryColor = {
    ...
    "best-practice": "border-emerald-500/30 text-emerald-400 bg-emerald-500/10",
